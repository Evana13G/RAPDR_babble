...
(:action push-rate:3.0
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-rate:76.5
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-rate:150.0
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-movementmagnitude:0.1
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-movementmagnitude:0.35
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-movementmagnitude:0.6
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-orientation:top
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)

(:action push-orientation:left
    :parameters (?g - gripper ?loc0 - cartesian ?o - obj )
    :precondition (at ?o ?loc0)
    :effect (not (at ?o ?loc0))
)
...
(:action shake-movementmagnitude:0.01
    :parameters (?g - gripper ?o - obj )
    :precondition (not (covered ?o))
    :effect (and
        (shaken ?o)
...
(:action shake-movementmagnitude:2.505
    :parameters (?g - gripper ?o - obj )
    :precondition (not (covered ?o))
    :effect (and
        (shaken ?o)
...
(:action shake-movementmagnitude:5.0
    :parameters (?g - gripper ?o - obj )
    :precondition (not (covered ?o))
    :effect (and
        (shaken ?o)
